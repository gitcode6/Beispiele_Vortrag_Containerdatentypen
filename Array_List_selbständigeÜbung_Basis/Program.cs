...
namespace Array_List_selbständigeÜbung_Basis
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Willkommen zur dynamischen Film-Verwaltung!");
            ...
            if (antwort == "ja")
            {
                ...
                bool gefunden = filme.Contains(suchFilm);
